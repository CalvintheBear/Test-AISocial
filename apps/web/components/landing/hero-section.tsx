      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Button
              size="lg"
              className="rounded-full bg-primary px-8 py-3 text-lg font-semibold text-primary-foreground shadow-lg transition-all hover:shadow-xl hover:scale-105"
              asChild
            >
              <Link href="/feed">
                开始创作
        ...
        <div className="mx-auto mt-16 max-w-4xl">
          <div className="relative rounded-2xl bg-card p-2 shadow-2xl backdrop-blur-sm">
            <div className="aspect-[16/9] overflow-hidden rounded-xl bg-gradient-to-br from-purple-100 to-pink-100">
