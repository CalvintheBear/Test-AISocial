      ...
      <Link href={href} onClick={handleNavigate} className="block">
        <div className="relative aspect-square overflow-hidden">
          <Image
            ...
            className="object-cover transition-transform duration-300 hover:scale-110 image-hover"
            quality={85}
          ...
          {artwork.status === 'draft' && (
            <Badge className="absolute top-3 right-3 bg-yellow-500 hover:bg-yellow-600 text-white shadow-sm">
              草稿
            </Badge>
          )}
          {showHotness && typeof artwork.hot_score === 'number' && artwork.hot_score > 0 && (
            <div className="absolute top-3 left-3">
              <Badge variant="secondary" className="bg-gray-100 text-gray-700 hover:bg-gray-200 shadow-sm">
